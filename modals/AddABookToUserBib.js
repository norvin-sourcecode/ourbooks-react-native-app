...
import {addBookToUserBib, getBookByIsbn, sendFriendRequest} from "../reducers/appSlice";
import {ButtonGroup, Card, Input, Overlay} from "react-native-elements";
import {AntDesign, Ionicons, MaterialIcons} from "@expo/vector-icons";
import {BarCodeScanner} from "expo-barcode-scanner";

const AddABookToUserBib = (props) => {
...
export default connect(mapStateToProps, mapDispatchToProps)(AddABookToUserBib)